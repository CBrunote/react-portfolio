...
const Skills = () => {
  return (
    <div name='skills' className='bg-neutral-50 text-neutral-900'>
        {/* Container */}
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full text-center'>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
              <div className='grayscale hover:filter-none hover:scale-110 duration-500 hover:filter-none'>
                <img className='w-20 mx-auto' src={html} alt='HTML icon'/>
                <p className='my-4 font-bold'>HTML</p>
              </div>
              <div className='grayscale hover:filter-none hover:scale-110 duration-500'>
